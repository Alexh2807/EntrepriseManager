...
import com.gravityyfh.roleplaycity.mdt.reset.MapResetManager;
...
public class MDTRushManager {
    ...
    private void initialize() {
        ...
        this.mapResetManager = new MapResetManager(plugin, config, blockTracker);
    ...
    public void registerListeners() {
        ...
        blockListener = new MDTBlockListener(plugin, this, blockTracker);
