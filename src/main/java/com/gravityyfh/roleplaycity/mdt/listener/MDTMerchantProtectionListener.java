...
public class MDTMerchantProtectionListener implements Listener {
    ...
    public void onPlayerInteractEntity(PlayerInteractEntityEvent event) {
        ...
        // Vérifier si le joueur est en mode setup MDT
        // Si oui, on laisse le listener de setup gérer
        // Sinon, on laisse le trade normal se faire

        // Le trade est automatiquement géré par Minecraft via les recettes
        // configurées sur le villageois
    }
