...
extends SubCommand {
    ...
    public boolean perform(Player player, String[] args) throws ExecutionException, InterruptedException {
        if (args.length == 3) {
            if (args[0].equalsIgnoreCase("give")) {
                ...
                try {
                    ...
                    if (economyResponse.transactionSuccess()) {
                        Bukkit.getConsoleSender().sendMessage("\u00a7r[light\u00a7cEconomy\u00a7r] Successfully added " + target + " " + args[2] + " " + currency);
                        return true;
                    }
            ...
            Bukkit.getConsoleSender().sendMessage("\u00a7r[light\u00a7cEconomy\u00a7r] Wrong command. Please use /eco add [playername] [amount]");
            return false;
        }
        Bukkit.getConsoleSender().sendMessage("\u00a7r[light\u00a7cEconomy\u00a7r] Wrong command. Please use /eco add [playername] [amount]");
        return false;
